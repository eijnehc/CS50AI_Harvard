...
class Sentence():
    ...
    def known_safes(self):
        ...
        """
        # if a sentence whose count is 0,
        # all of that sentence's cell must be 0
        if self.count == 0:
            return set(self.cells)
        else:
            return set()
    ...
    def mark_safe(self, cell):
        ...
        """
        # remove cell from the sentence altogether
        if cell in self.cells:
            self.cells.remove(cell)
            return True
        else:
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge:
            if len(sentence.cells) == 0:
                ...
                numcells = sentence.cells - prev_sentence.cells
                numcount = sentence.count - prev_sentence.count
                inferences.append(Sentence(numcells, numcount))
