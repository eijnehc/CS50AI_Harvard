...
class CrosswordCreator():
    ...
    def order_domain_values(self, var, assignment):
        ...
        lcv = sorted(order, key=order.get)
    ...
    def select_unassigned_variable(self, assignment):
        ...
        for var in self.crossword.variables - set(assignment):
            if (unassigned is None or len(self.domains[var]) < len(self.domains[unassigned]) or
            len(self.crossword.neighbors(var)) > len(self.crossword.neighbors(unassigned))):
                unassigned = var
    ...
    def backtrack(self, assignment):
        ...
        for value in self.order_domain_values(var, assignment):
            ...
            if self.consistent(next_assignment):
                result = self.backtrack(next_assignment)
                if result != None:
                    return result
        return None
